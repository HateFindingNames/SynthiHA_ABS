...
\chapter{Steckbrief}
    ...
    \section{Anwendung}\label{sec:anwendung}
            ...
            möglichst unterdrückt werden müssen, um \textit{warping}\footnote{Dt.: Verziehen/verwölben.} zu verhindern.

            liegt der Umstand, dass die fertigen Teile niemals völlig frei von einer gewissen Oberflächenrauhigkeit sind.
    ...
    \section{Besonderheiten}
            Wie bereits in den vorherigen Kapiteln erwähnt, ist bietet ABS eine Mischung günstiger mechanischer Eigenschaften
            bei gleichzeitig hoher Oberflächengüte, Kratzfestigkeit und lässt sich darüber hinaus besonders gut oberflächenbehandeln
            ohne dringende Notwendigkeit von potenziell umwelt- oder gesundheitsschädlichen Zusatzstoffen. Sollen seine
