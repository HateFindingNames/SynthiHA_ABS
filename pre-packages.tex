...
% \usepackage[hyphens, nobiblatex]{xurl}
...
\usepackage[ngerman]{cleveref} % löscht labels!!!!!!!!!! <--- warum? habs trotzdem eingefügt weil es die referencen nice macht ohne newcommands dafür zu brauchen. außerdem steht intellisense drauf ;)
...
% \usepackage{fontspec}% funzt nur mit xelatex